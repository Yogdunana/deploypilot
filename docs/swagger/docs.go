    ...
    "paths": {
        "/apps": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "status, data (array of App)",
                        "schema": {
                            "type": "object",
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "status, data (App object)",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/apps/{id}": {
            ...
            "put": {
                ...
                "responses": {
                    "200": {
                        "description": "status, data (updated App object)",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
            ...
            "delete": {
                ...
                "responses": {
                    "200": {
                        "description": "status, data.message, data.id",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/apps/{id}/backup": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "status, data.backup_id, data.app_id",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/apps/{id}/backups": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "status, data (array of DeploymentRecord)",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/apps/{id}/backups/{backupId}": {
            "delete": {
                ...
                "responses": {
                    "200": {
                        "description": "status, data.message, data.backup_id",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/apps/{id}/build": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Build and deploy overrides",
                        "name": "request",
                        "in": "body",
                        "schema": {
                            "type": "object",
                ...
                "responses": {
                    "200": {
                        "description": "status, data (BuildResult)",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        "type": "string",
                        "default": "false",
                        "description": "Set to 'true' for async deployment",
                        "name": "async",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "status, data (ContainerStatus)",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
                    ...
                    "400": {
                        "description": "invalid request or preflight failure",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/apps/{id}/env": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "status, data.app_id, data.env_vars",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Environment variables string",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    "200": {
                        "description": "status, data.app_id, data.message",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/apps/{id}/logs/container": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "status, data.container_name, data.tail, data.logs",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/apps/{id}/rollback": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Rollback request with previous image",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/audit-logs": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "status, data.logs, data.total, data.page, data.page_size",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/auth/login": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "status, data.user, data.token",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/cicd/status/{runID}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "status, data (build status)",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/cicd/trigger": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "CI build trigger request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    "200": {
                        "description": "status, data (build result)",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/credentials": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "status, data (array of Credential)",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "status, data (Credential)",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/credentials/{id}": {
            "put": {
                ...
                "responses": {
                    "200": {
                        "description": "status, data (updated Credential)",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/deployments/{id}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "status, data (DeploymentRecord)",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/dns/records": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "status, data (array of DNS records)",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
                    ...
                    "400": {
                        "description": "domain query parameter is required",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "DNS record creation request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    "200": {
                        "description": "status, data (DNS record)",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/dns/records/{id}": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "DNS record update request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    "200": {
                        "description": "status, data (updated DNS record)",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/monitor/alert-rules": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "status, data (array of AlertRule)",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/monitor/alerts": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "status, data (array of Alert)",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/monitor/check/{name}": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "status, data (health check result)",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/monitor/container/{name}": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "status, data (ContainerMetrics)",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/monitor/heal/{name}": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "status, data (heal result)",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/monitor/system": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "status, data (SystemMetrics)",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/notifications": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "status, data (array of Provider)",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Notification provider creation request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    "200": {
                        "description": "status, data (Provider)",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/notifications/{id}": {
            "put": {
                ...
                "responses": {
                    "200": {
                        "description": "status, data (updated Provider)",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/roles": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "status, data (array of Role)",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/servers": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "status, data (array of ServerInfo)",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "status, data (ServerInfo)",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/servers/{id}": {
            "put": {
                ...
                "responses": {
                    "200": {
                        "description": "status, data (updated ServerInfo)",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        "type": "integer",
                        "default": 2,
                        "description": "Detection depth level",
                        "name": "level",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Comma-separated list of ports to check",
                        "name": "ports",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "status, data (EnvironmentInfo)",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/servers/{id}/environment": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "status, data (server row with detected_info)",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/servers/{id}/test": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "status, data (test result)",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/system/health": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "status, data.status, data.database.status",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/system/update/check": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "status, data (update check result)",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/system/version": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "status, data.version, data.go, data.goos, data.goarch, data.num_cpu",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/templates": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "status, data (array of Template)",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "status, data.id, data.name, data.type",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/templates/{id}": {
            "put": {
                ...
                "responses": {
                    "200": {
                        "description": "status, data.id, data.message",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/users": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "status, data (array of User with Role)",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/users/me": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "status, data (User with Role and Tenant)",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
        ...
        "/users/{id}/role": {
            "put": {
                ...
                "responses": {
                    "200": {
                        "description": "status, data.user_id, data.role_id, data.role_name",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
                    ...
                    "400": {
                        "description": "invalid request or invalid role_id",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
