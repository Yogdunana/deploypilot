    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          props: true,
          meta: { titleKey: 'routes.serverTerminal', roles: ['owner', 'admin', 'dev'] },
        },
        {
          ...
          props: true,
          meta: { titleKey: 'routes.serverEnvironment', roles: ['owner', 'admin', 'dev'] },
        },
        {
          path: 'deployments',
          name: 'Deployments',
        ...
        },
        {
          ...
          meta: { titleKey: 'routes.batch', roles: ['owner', 'admin', 'dev'] },
        },
        {
          path: 'activity',
          name: 'ActivityFeed',
        ...
        },
        {
          ...
          meta: { titleKey: 'routes.users', roles: ['owner', 'admin'] },
        },
        {
          path: 'audit',
          name: 'Audit',
          component: () => import('@/views/Audit.vue'),
          meta: { titleKey: 'routes.audit', roles: ['owner', 'admin'] },
        },
        {
          path: 'system',
          name: 'System',
          component: () => import('@/views/System.vue'),
          meta: { titleKey: 'routes.system', roles: ['owner', 'admin'] },
        },
        {
          path: 'api-keys',
          name: 'ApiKeys',
          component: () => import('@/views/ApiKeys.vue'),
          meta: { titleKey: 'routes.apiKeys', roles: ['owner', 'admin'] },
        },
        {
          path: 'settings/security',
          name: 'SecuritySettings',
          component: () => import('@/views/SecuritySettings.vue'),
          meta: { titleKey: 'routes.security', roles: ['owner', 'admin'] },
        },
        {
          path: 'license',
          name: 'License',
        ...
        },
        {
          ...
          meta: { titleKey: 'routes.featureFlags', roles: ['owner', 'admin'] },
        },
        {
          path: 'trial',
          name: 'Trial',
